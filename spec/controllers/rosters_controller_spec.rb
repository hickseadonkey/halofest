  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved roster as @roster" do
        ...
        post :create, {:roster => { "user_id" => "invalid value" }}, valid_session
        assigns(:roster).should be_a_new(Roster)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested roster" do
        ...
        Roster.any_instance.should_receive(:update).with({ "user_id" => "" })
        put :update, {:id => roster.to_param, :roster => { "user_id" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the roster as @roster" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Roster.any_instance.stub(:save).and_return(false)
        put :update, {:id => roster.to_param, :roster => { "user_id" => "invalid value" }}, valid_session
        assigns(:roster).should eq(roster)
      end
