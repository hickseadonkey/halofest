  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved draft as @draft" do
        ...
        post :create, {:draft => { "year" => "invalid value" }}, valid_session
        assigns(:draft).should be_a_new(Draft)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested draft" do
        ...
        Draft.any_instance.should_receive(:update).with({ "year" => "1" })
        put :update, {:id => draft.to_param, :draft => { "year" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the draft as @draft" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Draft.any_instance.stub(:save).and_return(false)
        put :update, {:id => draft.to_param, :draft => { "year" => "invalid value" }}, valid_session
        assigns(:draft).should eq(draft)
      end
