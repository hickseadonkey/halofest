  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved pick as @pick" do
        ...
        post :create, {:pick => { "user_id" => "invalid value" }}, valid_session
        assigns(:pick).should be_a_new(Pick)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested pick" do
        ...
        Pick.any_instance.should_receive(:update).with({ "user_id" => "1" })
        put :update, {:id => pick.to_param, :pick => { "user_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the pick as @pick" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Pick.any_instance.stub(:save).and_return(false)
        put :update, {:id => pick.to_param, :pick => { "user_id" => "invalid value" }}, valid_session
        assigns(:pick).should eq(pick)
      end
